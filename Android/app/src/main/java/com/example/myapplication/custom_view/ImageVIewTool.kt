...
class ImageVIewTool : View {
    ...
    constructor(context: Context?, attrs: AttributeSet?) : super(context, attrs){
        ...
        mBitmap=mResources?.getDrawable(R.mipmap.ic_launcher_round,null)?.toBitmap();
    }
    ...
    override fun onDraw(canvas: Canvas?) {
        ...
        var sc=canvas?.saveLayer(0f,0f, mkWidth.toFloat(), mkHeight.toFloat()-20,mPaint3,Canvas.ALL_SAVE_FLAG);
        ...
        canvas?.drawBitmap(mBitmap!!, null,RectF((0).toFloat(),(0).toFloat(),(mkWidth).toFloat(),(mkHeight).toFloat()),mPaint3);
